...
file1 <- oef_input("trust_tumor_phenotypes.xlsx")
outdir  <- oef_output("clinical_tumor")
PlotDir <- oef_output("clinical_tumor/plots")
...
cat("\nTumor outputs saved to:\n", outdir, "\n")
cat("Tumor plots saved to:\n", PlotDir, "\n")
