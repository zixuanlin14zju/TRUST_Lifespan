...
file1 <- oef_input("trust_neurodegenerative_phenotypes.xlsx")
outdir  <- oef_output("clinical_dementia")
PlotDir <- oef_output("clinical_dementia/plots")
...
cat("\nDementia outputs saved to:\n", outdir, "\n")
cat("Dementia plots saved to:\n", PlotDir, "\n")
