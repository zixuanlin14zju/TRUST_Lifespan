...
file_path <- oef_input("trust_traveling_subjects.xlsx")
sheet_name <- 1
outdir <- oef_output("reproducibility_traveling")
...
p_line <- ggplot(site_pairs_long, aes(x = Site, y = OEF, group = name)) +
