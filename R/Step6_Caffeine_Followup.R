...
file_path <- oef_input("trust_caffeine_followup.xlsx")
outdir    <- oef_output("reproducibility_caffeine")
...
theme_pub <- theme_classic(base_size = base_font_size, base_family = "sans") +
  theme(
